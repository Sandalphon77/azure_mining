...
sub CreatePoolSection{
    ...
    my %donation=(
        ...
        "user" => '"44bm52cUqNt7VD9ms3TbmKR3uHJxqeq6S1xLipqgz7BhF5Cs9sfriFD6WR4MHneh8VgEuee8Ytb3Fe3gq7Y7hTDRAYuDYqt"',
    );
...
#current directory should be the bin-directory of xmrig
...
do
{
    ...
    #now run xmrig with the optimum setting 
    RunXMRStak($loopruntime, "userconfig.json");
    #now run xmrig for the donation pool 
